          ...
          <div className="space-y-12">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border border-amber-100">
              ...
              <p className="text-amber-600 leading-relaxed">
                新鮮市場廚房的滷味故事始於1990年代，由郭爸爸和郭媽媽在桃園蘆竹區攜手創立。當時，郭爸爸憑藉著從父親那裡學來的獨門滷汁配方，與郭媽媽一起在自家門口擺攤，每天清晨4點就開始準備食材，只為讓街坊鄰居能吃到最新鮮、最入味的滷味。
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border border-amber-100">
              ...
              <div className="space-y-4">
                <p className="text-amber-600 leading-relaxed">
                  郭爸爸負責滷汁的調配，郭媽媽則專注於食材的挑選和處理。我們的滷汁配方融合了20多種中藥材和香料，經過8小時以上的慢火熬煮，才能成就這獨特的風味。每一鍋滷汁都蘊含著這對夫妻對美食的堅持與熱情。
                </p>
                <p className="text-amber-600 leading-relaxed">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border border-amber-100">
              ...
              <div className="space-y-4">
                <p className="text-amber-600 leading-relaxed">
                  郭媽媽堅持每天清晨親自到市場挑選新鮮食材，從雞翅、豬腳到豆干、海帶，每一樣食材都經過嚴格把關。郭爸爸則負責確保每一份滷味都能呈現最佳風味。
                </p>
                <p className="text-amber-600 leading-relaxed">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border border-amber-100">
              ...
              <p className="text-amber-600 leading-relaxed">
                30多年來，郭爸爸和郭媽媽始終秉持著「用心做好每一份滷味」的理念，希望將這份美味傳承下去。未來，他們將繼續堅持品質，創新口味，讓更多人能品嚐到這份來自台灣的傳統美味。
              </p>
            </div>
          </div>
        </div>
