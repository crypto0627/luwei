export default function PrivacyPolicyPage() {
  return (
    <div className="min-h-[calc(100vh-80px)] bg-gradient-to-br from-amber-50 via-orange-50 to-white py-24">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold text-amber-800 mb-8 text-center">
          隱私權政策
        </h1>

        <div className="bg-white/80 backdrop-blur-sm rounded-lg shadow-xl p-8 space-y-6">
          <p className="text-gray-700">
            非常歡迎您光臨「大竹小倆口滷味」（以下簡稱本網站），為了讓您能夠安心的使用本網站的各項服務與資訊，特此向您說明本網站的隱私權保護政策，以保障您的權益，請您詳閱下列內容：
          </p>
